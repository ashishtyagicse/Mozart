...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    ResultSet rs = stmt.executeQuery("SELECT * from Artist where ArtistId="+Session1.getAttribute("userid"));
...
<form action="ProfileArtistController" method="POST">
	...
	<div id="formrowone">
		<div style="float: left;">Artist Biodata:</div>
		<div style="float: right;">
		<input id="bio"  name="bio" type="text" value="<%out.print(rs.getString(5)); %>" size="30" /><br />
	</div>
	</div>
		<BR>
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="dob"  name="dob" type="text" value="<%out.print(rs.getString(10)); %>" size="30" /><br />
	</div>
	</div>
	<BR>
	
		<div id="formrowone">
		<div style="float: left;">Artist Music:</div>
		<div style="float: right;">
	...
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="marital"  name="marital" type="text" value="<%out.print(rs.getString(6)); %>" size="30" /><br />
	</div>
	</div>
	<BR>
	...
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="Gender"  name="Gender" type="text" value="<%out.print(rs.getString(11)); %>" size="30" /><br />
	</div>
	</div>
	<br>
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="InterestedIn"  name="InterestedIn" type="text" value="<%out.print(rs.getString(12)); %>" size="30" /><br />
	</div>
	</div>
	<br>
	...
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="ReligiousViews"  name="ReligiousViews" type="text" value="<%out.print(rs.getString(13)); %>" size="30" /><br />
	</div>
	</div>
	<br>
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="PoliticalViews"  name="PoliticalViews" type="text" value="<%out.print(rs.getString(14)); %>" size="30" /><br />
	</div>
	</div>
	<br>
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="MotherTongue"  name="MotherTongue" type="text" value="<%out.print(rs.getString(15)); %>" size="30" /><br />
	</div>
	</div>
	<br>
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="University"  name="University" type="text" value="<%out.print(rs.getString(17)); %>" size="30" /><br />
	</div>
	</div>
	<br>
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="School"  name="School" type="text" value="<%out.print(rs.getString(18)); %>" size="30" /><br />
	</div>
	</div><br>
	...
	<div id="formrowone">
		...
		<div style="float: right;">
		<input id="city"  name="city" type="text" value="<%out.print(rs.getString(16));}%>" size="30" /><br />
	</div>
	</div>
	<br>
	<div id="formrowone">
	...
	<br>
	<input id="submit_button" type="submit" value="Update Profile" />
</form>	
</div>
		</div>
		<div align="center">
			<h3>
				<a id="Home" href="/mozart/ArtistHome.jsp">Home</a>
			</h3>
		</div>
	</div>
</body>
