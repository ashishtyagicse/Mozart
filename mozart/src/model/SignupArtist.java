...
public class SignupArtist {
	...
	public SignupArtist(String userfname, String userlname, String dob,
	...
	public int CreateArtist() {
		if (this.UserFName != "" && this.UserLName != ""
			...
			String insertStoreProc = "{call ArtistSignUp(?,?,?,?,?,?,?,?)}";
			try {			
